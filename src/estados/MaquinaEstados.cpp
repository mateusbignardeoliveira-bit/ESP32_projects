...
// Quantidade de sensores pretos no instante da entrada.
...
//
// Não inventamos uma estratégia aqui.
// --------------------------------------------------------
...
// PRIMEIRO GIRO
//
// Obrigatoriamente realizado pelo ControleGiro,
// portanto pelo ICM-20948.
// --------------------------------------------------------
...
switch(estado)
{
    ...
    case OBSTACULO_RETO_1:
        ...
        // Condição provisória.
        // Será ajustada posteriormente com a geometria
        // definitiva do obstáculo.
        if(!analiseTOF.temObstaculo())
        {
            controleGiro.curva90Direita();
